...
# v0.19.0.54 (Phase K3 T018 ship 装机验): build wrapper.
# Hardcoded path to avoid $PSScriptRoot quirks when invoked via Start-Process
# from background runner.
$wrapperPath = "F:\soft\00selfmade\rime_claude\_build_v054_step1.cmd"
...
Write-Host "Running: xbuild.bat weasel installer (v0.19.0.54)"
