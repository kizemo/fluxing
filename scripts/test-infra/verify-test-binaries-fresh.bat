@echo off
rem ====================================================================
rem scripts\test-infra\verify-test-binaries-fresh.bat - 13 test projects (spec 033 adds TestDarkModeBridge; spec 034 adds TestDarkModeBroadcast)
rem L31 stale-binary detector. For each of the 13 test projects, compares
...
rem
rem Usage: scripts\test-infra\verify-test-binaries-fresh.bat - 13 test projects (spec 033 adds TestDarkModeBridge; spec 034 adds TestDarkModeBroadcast)
...
for %%P in (TestDefaultHotkeys TestShiftSelectBinding TestBindingResolution TestResponseParser TestWeaselIPC TestYamlRoundTripE2E TestUserDictUpdate TestCandidateRButtonDown TestCandidateIgnoreFilter TestPanelDarkModeSubscribe TestTrayRestoreIgnored TestDarkModeBridge TestDarkModeBroadcast) do (
