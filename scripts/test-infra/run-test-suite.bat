...
rem Build + run all 14 test projects for Fluxing. spec 031 adds TestCandidateIgnoreFilter. spec 033 adds TestDarkModeBridge. spec 034 adds TestDarkModeBroadcast. spec 036 adds TestQuickPanelDialog.
rem
...
for %%E in (TestDefaultHotkeys TestShiftSelectBinding TestBindingResolution TestResponseParser TestYamlRoundTripE2E TestUserDictUpdate TestCandidateRButtonDown TestCandidateIgnoreFilter TestPanelDarkModeSubscribe TestTrayRestoreIgnored TestDarkModeBridge TestDarkModeBroadcast TestQuickPanelDialog) do (
    echo === Running %%E.exe ===
